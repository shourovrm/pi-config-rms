...
const ORACLE_MODELS = [
	...
	{ provider: "opencode-go", model: "deepseek-v4-pro", name: "DeepSeek V4 Pro" },
	{ provider: "opencode-go", model: "glm-5", name: "GLM-5" },
	{ provider: "opencode-go", model: "glm-5.1", name: "GLM-5.1" },
	{ provider: "opencode-go", model: "kimi-k2.5", name: "Kimi K2.5" },
	{ provider: "opencode-go", model: "kimi-k2.6", name: "Kimi K2.6 (3x limits)" },
	{ provider: "opencode-go", model: "mimo-v2-omni", name: "MiMo V2 Omni" },
	{ provider: "opencode-go", model: "mimo-v2-pro", name: "MiMo V2 Pro" },
	{ provider: "opencode-go", model: "mimo-v2.5", name: "MiMo V2.5" },
	{ provider: "opencode-go", model: "mimo-v2.5-pro", name: "MiMo V2.5 Pro" },
	{ provider: "opencode-go", model: "minimax-m2.5", name: "MiniMax M2.5" },
	{ provider: "opencode-go", model: "minimax-m2.7", name: "MiniMax M2.7" },
	{ provider: "opencode-go", model: "qwen3.5-plus", name: "Qwen3.5 Plus" },
	{ provider: "opencode-go", model: "qwen3.6-plus", name: "Qwen3.6 Plus" },
] as const;
